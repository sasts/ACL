...
@Configuration
@EnableWebMvc
@ComponentScan(basePackages = "pl.datacenter")
@EnableJpaRepositories(basePackages = "pl.datacenter")
...
public class AppConfig implements WebMvcConfigurer {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        em.setPackagesToScan(new String[] {"pl.datacenter"});
    ...
    public DataSource dataSource() {
        ...
        dataSource.setUrl("jdbc:mysql://localhost:3306/acl?useSSL=false");
